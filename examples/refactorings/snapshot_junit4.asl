...
method("Assert", "assertNotEquals", 3, 1, "marvinware2005@gmail.com").
calls("Assert", "assertNotEquals", "Assert", "assertNotEquals").
method("Assert", "assertArrayEquals", 3, 1, "dsaff").
...
method("Assume", "assumeTrue", 5, 2, "dsaff").
method("Assume", "assumeFalse", 3, 1, "matthew@farwell.co.uk").
calls("Assume", "assumeFalse", "Assume", "assumeTrue").
...
class("RealSystem").
method("RealSystem", "exit", 3, 1, "kbeck").
calls("RealSystem", "exit", "System", "exit").
method("RealSystem", "out", 3, 1, "kbeck").
...
method("Throwables", "getStacktrace", 6, 1, "scotto.alberto.86@gmail.com").
calls("Throwables", "getStacktrace", "Throwable", "printStackTrace").
calls("Throwables", "getStacktrace", "StringWriter", "toString").
method("Throwables", "getTrimmedStackTrace", 10, 2, "kcooney@users.noreply.github.com").
...
method("ExactComparisonCriteria", "assertElementsEqual", 3, 1, "saff@dhcp-172-31-197-71.cam.corp.google.com").
...
method("TextListener", "testStarted", 3, 1, "dsaff").
calls("TextListener", "testStarted", "PrintStream", "append").
method("TextListener", "testFailure", 3, 1, "dsaff").
calls("TextListener", "testFailure", "PrintStream", "append").
method("TextListener", "testIgnored", 3, 1, "dsaff").
calls("TextListener", "testIgnored", "PrintStream", "append").
method("TextListener", "getWriter", 3, 1, "dsaff").
method("TextListener", "printHeader", 4, 1, "dsaff").
...
method("TextListener", "printFailure", 4, 1, "dsaff").
calls("TextListener", "printFailure", "TextListener", "getWriter").
calls("TextListener", "printFailure", "TextListener", "getWriter").
method("TextListener", "printFooter", 12, 2, "dsaff").
...
calls("TextListener", "printFooter", "TextListener", "getWriter").
calls("TextListener", "printFooter", "TextListener", "getWriter").
method("TextListener", "elapsedTimeAsString", 3, 1, "dsaff").
...
method("ParentRunner", "runChild", 1, 1, "dsaff").
method("ParentRunner", "collectInitializationErrors", 6, 1, "dsaff").
...
method("ParentRunner", "runChildren", 8, 2, "dsaff").
calls("ParentRunner", "runChildren", "RunnerScheduler", "schedule").
calls("ParentRunner", "runChildren", "RunnerScheduler", "finished").
method("ParentRunner", "getName", 3, 1, "dsaff").
calls("ParentRunner", "getName", "TestClass", "getName").
method("ParentRunner", "getTestClass", 3, 1, "dsaff").
method("ParentRunner", "runLeaf", 12, 3, "kcooney@google.com").
...
method("ParentRunner", "filter", 21, 5, "dsaff").
...
method("BlockJUnit4ClassRunner", "validateConstructor", 4, 1, "dsaff").
...
method("BlockJUnit4ClassRunner", "validateOnlyOneConstructor", 6, 2, "dsaff").
...
method("BlockJUnit4ClassRunner", "createTest", 3, 1, "kbeck").
...
method("Suite", "getChildren", 3, 1, "dsaff").
method("Suite", "describeChild", 3, 1, "dsaff").
calls("Suite", "describeChild", "Runner", "getDescription").
method("Suite", "runChild", 3, 1, "dsaff").
...
method("ExpectedException", "reportMissingExceptionWithMessage", 4, 1, "coreyjv@gmail.com").
method("ExpectedException", "apply", 3, 1, "saff@redredrobot.home").
...
calls("ErrorCollector", "checkSucceeds", "ErrorCollector", "addError").
method("ErrorCollector", "checkThrows", 6, 2, "kcooney@google.com").
...
class("Verifier").
method("Verifier", "apply", 3, 1, "saff@redredrobot.home").
method("Verifier", "verify", 1, 1, "saff@new-host-3.home").

# junit4/src/main/java/org/junit/rules/TestWatcher.java

class("TestWatcher").
method("TestWatcher", "apply", 3, 1, "david@saff.net").
method("TestWatcher", "succeededQuietly", 6, 2, "davidhart82@gmail.com").
calls("TestWatcher", "succeededQuietly", "TestWatcher", "succeeded").
calls("TestWatcher", "succeededQuietly", "List", "add").
method("TestWatcher", "failedQuietly", 6, 2, "davidhart82@gmail.com").
calls("TestWatcher", "failedQuietly", "TestWatcher", "failed").
calls("TestWatcher", "failedQuietly", "List", "add").
method("TestWatcher", "skippedQuietly", 10, 3, "mark.michaelis@coremedia.com").
calls("TestWatcher", "skippedQuietly", "TestWatcher", "skipped").
calls("TestWatcher", "skippedQuietly", "TestWatcher", "skipped").
calls("TestWatcher", "skippedQuietly", "List", "add").
method("TestWatcher", "startingQuietly", 6, 2, "davidhart82@gmail.com").
calls("TestWatcher", "startingQuietly", "TestWatcher", "starting").
calls("TestWatcher", "startingQuietly", "List", "add").
method("TestWatcher", "finishedQuietly", 6, 2, "davidhart82@gmail.com").
calls("TestWatcher", "finishedQuietly", "TestWatcher", "finished").
calls("TestWatcher", "finishedQuietly", "List", "add").
method("TestWatcher", "succeeded", 1, 1, "david@saff.net").
method("TestWatcher", "failed", 1, 1, "david@saff.net").
method("TestWatcher", "skipped", 4, 1, "mark.michaelis@coremedia.com").
calls("TestWatcher", "skipped", "TestWatcher", "skipped").
method("TestWatcher", "skipped", 1, 1, "mark.michaelis@coremedia.com").
method("TestWatcher", "starting", 1, 1, "david@saff.net").
method("TestWatcher", "finished", 1, 1, "david@saff.net").

# junit4/src/main/java/org/junit/rules/TestWatchman.java

class("TestWatchman").
method("TestWatchman", "apply", 3, 1, "saff@redredrobot.home").
method("TestWatchman", "succeeded", 1, 1, "saff@new-host-4.home").
method("TestWatchman", "failed", 1, 1, "saff@new-host-4.home").
method("TestWatchman", "starting", 1, 1, "saff@redredrobot.home").
method("TestWatchman", "finished", 1, 1, "saff@redredrobot.home").
...
calls("TemporaryFolder", "createTemporaryFolderIn", "File", "delete").
method("TemporaryFolder", "getRoot", 6, 2, "saff@new-host-3.home").
method("TemporaryFolder", "delete", 7, 3, "saff@new-host-3.home").
calls("TemporaryFolder", "delete", "TemporaryFolder", "tryDelete").
calls("TemporaryFolder", "delete", "TemporaryFolder", "fail").
method("TemporaryFolder", "tryDelete", 6, 2, "narendra.pathai@gmail.com").
...
method("ExpectedExceptionMatcherBuilder", "add", 3, 1, "mail@marcphilipp.de").
...
method("Timeout", "getTimeout", 3, 1, "kcooney@google.com").
calls("Timeout", "getTimeout", "TimeUnit", "convert").
method("Timeout", "getLookingForStuckThread", 3, 1, "kcooney@google.com").
method("Timeout", "createFailOnTimeoutStatement", 3, 1, "kcooney@google.com").
calls("Timeout", "createFailOnTimeoutStatement", "FailOnTimeout", "builder").
method("Timeout", "apply", 6, 2, "saff@redredrobot.home").
...
method("ExternalResource", "apply", 3, 1, "saff@redredrobot.home").
calls("ExternalResource", "apply", "ExternalResource", "statement").
method("ExternalResource", "statement", 3, 1, "david@saff.net").
method("ExternalResource", "before", 1, 1, "saff@new-host-3.home").
method("ExternalResource", "after", 1, 1, "saff@new-host-3.home").
...
method("DisableOnDebug", "isDebugging", 3, 1, "doug@neverfear.org").
...
method("Result", "getRunTime", 3, 1, "dsaff").
calls("Result", "getRunTime", "AtomicLong", "get").
method("Result", "getFailures", 3, 1, "dsaff").
...
class("Computer").
method("Computer", "serial", 3, 1, "kbeck").
method("Computer", "getSuite", 3, 1, "kbeck").
method("Computer", "getRunner", 3, 1, "kbeck").
calls("Computer", "getRunner", "RunnerBuilder", "runnerForClass").

# junit4/src/main/java/org/junit/runner/Runner.java

class("Runner").
method("Runner", "getDescription", 1, 1, "dsaff").
method("Runner", "run", 1, 1, "dsaff").
method("Runner", "testCount", 3, 1, "dsaff").
...
method("Description", "createTestDescription", 3, 1, "dsaff").
method("Description", "createTestDescription", 3, 1, "dsaff").
method("Description", "formatDisplayName", 3, 1, "jglick@cloudbees.com").
calls("Description", "formatDisplayName", "String", "format").
method("Description", "createSuiteDescription", 3, 1, "dsaff").
method("Description", "createSuiteDescription", 3, 1, "dsaff").
method("Description", "getDisplayName", 3, 1, "dsaff").
method("Description", "addChild", 3, 1, "dsaff").
calls("Description", "addChild", "Collection", "add").
method("Description", "getChildren", 3, 1, "dsaff").
method("Description", "isSuite", 3, 1, "dsaff").
calls("Description", "isSuite", "Description", "isTest").
method("Description", "isTest", 3, 1, "dsaff").
...
method("Description", "toString", 3, 1, "dsaff").
calls("Description", "toString", "Description", "getDisplayName").
method("Description", "isEmpty", 3, 1, "dsaff").
calls("Description", "isEmpty", "Description", "equals").
method("Description", "childlessCopy", 3, 1, "dsaff").
method("Description", "getAnnotation", 7, 3, "dsaff").
...
class("Request").
method("Request", "method", 4, 1, "dsaff").
calls("Request", "method", "Request", "aClass").
method("Request", "aClass", 3, 1, "dsaff").
method("Request", "classWithoutSuiteMethod", 3, 1, "dsaff").
method("Request", "classes", 8, 2, "dsaff").
...
method("Request", "runner", 3, 1, "dsaff").
...
method("JUnitCore", "addListener", 3, 1, "dsaff").
calls("JUnitCore", "addListener", "RunNotifier", "addListener").
method("JUnitCore", "removeListener", 3, 1, "dsaff").
calls("JUnitCore", "removeListener", "RunNotifier", "removeListener").
method("JUnitCore", "defaultComputer", 3, 1, "kbeck").
...
method("JUnitCommandLineParseResult", "createRequest", 8, 2, "noel.yap+github.com@gmail.com").
...
method("AnnotationValidator", "validateAnnotatedClass", 3, 1, "ricky@dius.com.au").
method("AnnotationValidator", "validateAnnotatedField", 3, 1, "ricky@dius.com.au").
method("AnnotationValidator", "validateAnnotatedMethod", 3, 1, "ricky@dius.com.au").
...
method("AnnotationValidatorFactory", "createAnnotationValidator", 13, 3, "ricky@dius.com.au").
...
method("PublicClassValidator", "validateTestClass", 7, 2, "mail@stefan-birkner.de").
...
method("AnnotationsValidator", "validateTestClass", 7, 2, "mail@stefan-birkner.de").
...
calls("MethodValidator", "validateStaticMethods", "MethodValidator", "validateTestMethods").
method("MethodValidator", "validateMethodsForDefaultRunner", 6, 1, "dsaff").
...
method("MethodValidator", "assertValid", 5, 2, "dsaff").
calls("MethodValidator", "assertValid", "List", "isEmpty").
method("MethodValidator", "validateNoArgConstructor", 6, 2, "dsaff").
...
method("TestClass", "getName", 3, 1, "dsaff").
...
method("TestMethod", "invoke", 3, 1, "dsaff").
...
method("MethodRoadie", "runTestMethod", 23, 7, "dsaff").
...
calls("MethodRoadie", "runTestMethod", "MethodRoadie", "addFailure").
calls("MethodRoadie", "runTestMethod", "MethodRoadie", "addFailure").
method("MethodRoadie", "runBefores", 14, 5, "dsaff").
...
method("JUnit4ClassRunner", "run", 3, 1, "dsaff").
...
method("JUnit4ClassRunner", "getName", 3, 1, "dsaff").
...
method("JUnit4ClassRunner", "wrapMethod", 3, 1, "dsaff").
...
method("JUnit4ClassRunner", "sort", 3, 1, "dsaff").
calls("JUnit4ClassRunner", "sort", "Collections", "sort").
method("JUnit4ClassRunner", "getTestClass", 3, 1, "dsaff").
...
method("ClassRoadie", "runProtected", 8, 2, "dsaff").
...
method("ClassRoadie", "runBefores", 14, 5, "dsaff").
...
calls("ErrorReportingRunner", "getCauses", "ErrorReportingRunner", "singletonList").
method("ErrorReportingRunner", "describeCause", 3, 1, "dsaff").
calls("ErrorReportingRunner", "describeCause", "Description", "createTestDescription").
method("ErrorReportingRunner", "runCause", 6, 1, "dsaff").
...
class("JUnit4Builder").
method("JUnit4Builder", "runnerForClass", 3, 1, "dsaff").
...
method("AllDefaultPossibilitiesBuilder", "annotatedBuilder", 3, 1, "dsaff").
method("AllDefaultPossibilitiesBuilder", "ignoredBuilder", 3, 1, "dsaff").
method("AllDefaultPossibilitiesBuilder", "suiteMethodBuilder", 6, 2, "dsaff").
...
class("NullBuilder").
method("NullBuilder", "runnerForClass", 3, 1, "dsaff").
...
method("StacktracePrintingMatcher", "isThrowable", 3, 1, "mail@marcphilipp.de").
method("StacktracePrintingMatcher", "isException", 3, 1, "mail@marcphilipp.de").
...
method("FakeRuntimeMXBean", "getInputArguments", 3, 1, "kcooney@users.noreply.github.com").
...
method("ManagementFactory", "getRuntimeMXBean", 3, 1, "kcooney@users.noreply.github.com").
method("ManagementFactory", "getThreadMXBean", 3, 1, "kcooney@users.noreply.github.com").
...
method("FakeThreadMXBean", "getThreadCpuTime", 3, 1, "kcooney@users.noreply.github.com").
method("FakeThreadMXBean", "isThreadCpuTimeSupported", 3, 1, "kcooney@users.noreply.github.com").
...
method("FailOnTimeout", "getResult", 14, 5, "kcooney@google.com").
...
method("ReflectiveCallable", "run", 6, 2, "dsaff").
...
method("ReflectiveCallable", "runReflectiveCall", 1, 1, "dsaff").
...
method("EachTestNotifier", "addMultipleFailureException", 4, 2, "saff@dhcp-172-31-197-85.cam.corp.google.com").
calls("EachTestNotifier", "addMultipleFailureException", "EachTestNotifier", "addFailure").
method("EachTestNotifier", "addFailedAssumption", 3, 1, "dsaff").
calls("EachTestNotifier", "addFailedAssumption", "RunNotifier", "fireTestAssumptionFailed").
method("EachTestNotifier", "fireTestFinished", 3, 1, "dsaff").
calls("EachTestNotifier", "fireTestFinished", "RunNotifier", "fireTestFinished").
method("EachTestNotifier", "fireTestStarted", 3, 1, "dsaff").
calls("EachTestNotifier", "fireTestStarted", "RunNotifier", "fireTestStarted").
method("EachTestNotifier", "fireTestIgnored", 3, 1, "dsaff").
calls("EachTestNotifier", "fireTestIgnored", "RunNotifier", "fireTestIgnored").
method("EachTestNotifier", "fireTestSuiteStarted", 3, 1, "charlie@yandex-team.ru").
calls("EachTestNotifier", "fireTestSuiteStarted", "RunNotifier", "fireTestSuiteStarted").
method("EachTestNotifier", "fireTestSuiteFinished", 3, 1, "charlie@yandex-team.ru").
...
method("IncludeCategories", "createFilter", 3, 1, "noel.yap+github.com@gmail.com").
...
method("ExcludeCategories", "createFilter", 3, 1, "noel.yap+github.com@gmail.com").
...
method("CategoryValidator", "validateAnnotatedMethod", 10, 4, "ricky@dius.com.au").
...
method("CategoryValidator", "addErrorMessage", 4, 1, "ricky@dius.com.au").
...
method("PrintableResult", "failures", 3, 1, "kcooney@google.com").
calls("PrintableResult", "failures", "Result", "getFailures").
method("PrintableResult", "toString", 5, 1, "dsaff").
...
method("ResultMatchers", "hasSingleFailureContaining", 3, 1, "dsaff").
method("ResultMatchers", "hasSingleFailureMatching", 3, 1, "kcooney@google.com").
method("ResultMatchers", "hasFailureContaining", 3, 1, "dsaff").

# junit4/src/main/java/org/junit/experimental/theories/ParameterSupplier.java

class("ParameterSupplier").
method("ParameterSupplier", "getValueSources", 1, 1, "dsaff").
...
method("PotentialAssignment", "forValue", 3, 1, "dsaff").
method("PotentialAssignment", "getValue", 1, 1, "dsaff").
method("PotentialAssignment", "getDescription", 1, 1, "dsaff").
...
method("ParameterSignature", "putSymmetrically", 4, 1, "pimterry@gmail.com").
...
method("ParameterSignature", "getType", 3, 1, "dsaff").
...
calls("ParameterSignature", "findDeepAnnotation", "Class", "cast").
method("ParameterSignature", "getAnnotation", 7, 3, "dsaff").
...
method("ParameterizedAssertionError", "stringValueOf", 6, 2, "dsaff").
...
method("Assignments", "nextUnassigned", 3, 1, "dsaff").
...
method("SpecificDataPointsSupplier", "getDataPointsFields", 11, 3, "pimterry@gmail.com").
...
method("SpecificDataPointsSupplier", "getSingleDataPointMethods", 11, 3, "pimterry@gmail.com").
...
method("SpecificDataPointsSupplier", "getDataPointsMethods", 11, 3, "pimterry@gmail.com").
...
method("BlockJUnit4ClassRunnerWithParametersFactory", "createRunnerForTestWithParameters", 3, 1, "mail@stefan-birkner.de").
...
method("BlockJUnit4ClassRunnerWithParameters", "getInjectionType", 7, 2, "mail@stefan-birkner.de").
calls("BlockJUnit4ClassRunnerWithParameters", "getInjectionType", "BlockJUnit4ClassRunnerWithParameters", "fieldsAreAnnotated").
method("BlockJUnit4ClassRunnerWithParameters", "fieldsAreAnnotated", 3, 1, "mail@stefan-birkner.de").
...
class("RunnerBuilder").
method("RunnerBuilder", "runnerForClass", 1, 1, "dsaff").
method("RunnerBuilder", "safeRunnerForClass", 6, 2, "dsaff").
calls("RunnerBuilder", "safeRunnerForClass", "RunnerBuilder", "runnerForClass").
method("RunnerBuilder", "addParent", 6, 2, "dsaff").
calls("RunnerBuilder", "addParent", "Set", "add").
method("RunnerBuilder", "removeParent", 3, 1, "dsaff").
calls("RunnerBuilder", "removeParent", "Set", "remove").
method("RunnerBuilder", "runners", 7, 1, "dsaff").
...
calls("TestClass", "scanAnnotatedMembers", "TestClass", "addToAnnotationLists").
method("TestClass", "getSortedDeclaredFields", 5, 1, "ricky@dius.com.au").
calls("TestClass", "getSortedDeclaredFields", "Arrays", "sort").
method("TestClass", "addToAnnotationLists", 14, 4, "dsaff").
...
calls("TestClass", "getName", "Class", "getName").
method("TestClass", "getOnlyConstructor", 5, 1, "dsaff").
calls("TestClass", "getOnlyConstructor", "Assert", "assertEquals").
method("TestClass", "getAnnotations", 6, 2, "dsaff").
calls("TestClass", "getAnnotations", "Class", "getAnnotations").
method("TestClass", "getAnnotation", 6, 2, "rowan.hill@softwire.com").
...
method("FrameworkMethod", "getReturnType", 3, 1, "matthew@farwell.co.uk").
calls("FrameworkMethod", "getReturnType", "Method", "getReturnType").
method("FrameworkMethod", "getType", 3, 1, "matthew@farwell.co.uk").
calls("FrameworkMethod", "getType", "FrameworkMethod", "getReturnType").
method("FrameworkMethod", "getDeclaringClass", 3, 1, "st.ferstl@gmail.com").
calls("FrameworkMethod", "getDeclaringClass", "Method", "getDeclaringClass").
method("FrameworkMethod", "validateNoTypeParametersOnArgs", 3, 1, "pholser@alumni.rice.edu").
method("FrameworkMethod", "handlePossibleBridgeMethod", 12, 4, "kcooney@google.com").
...
method("FrameworkMethod", "isShadowedBy", 16, 6, "dsaff").
...
method("FrameworkMethod", "getAnnotation", 3, 1, "dsaff").
calls("FrameworkMethod", "getAnnotation", "Method", "getAnnotation").
method("FrameworkMethod", "toString", 3, 1, "mail@stefan-birkner.de").
...
method("FrameworkField", "getAnnotation", 3, 1, "rowan.hill@softwire.com").
calls("FrameworkField", "getAnnotation", "Field", "getAnnotation").
method("FrameworkField", "isShadowedBy", 3, 1, "saff@redredrobot.home").
method("FrameworkField", "handlePossibleBridgeMethod", 3, 1, "kcooney@google.com").
method("FrameworkField", "isBridgeMethod", 3, 1, "kcooney@users.noreply.github.com").
method("FrameworkField", "getModifiers", 3, 1, "mail@stefan-birkner.de").
calls("FrameworkField", "getModifiers", "Field", "getModifiers").
method("FrameworkField", "getField", 3, 1, "saff@new-host-2.home").
method("FrameworkField", "getType", 3, 1, "aisrael@gmail.com").
calls("FrameworkField", "getType", "Field", "getType").
method("FrameworkField", "getDeclaringClass", 3, 1, "st.ferstl@gmail.com").
calls("FrameworkField", "getDeclaringClass", "Field", "getDeclaringClass").
method("FrameworkField", "get", 3, 1, "saff@new-host-2.home").
calls("FrameworkField", "get", "Field", "get").
method("FrameworkField", "toString", 3, 1, "mail@stefan-birkner.de").
...
method("FrameworkMember", "isShadowedBy", 1, 1, "saff@redredrobot.home").
method("FrameworkMember", "handlePossibleBridgeMethod", 1, 1, "kcooney@users.noreply.github.com").
...
method("FrameworkMember", "getDeclaringClass", 1, 1, "st.ferstl@gmail.com").

# junit4/src/main/java/org/junit/runners/model/Statement.java

class("Statement").
method("Statement", "evaluate", 1, 1, "kbeck").
...
method("NoGenericTypeParametersValidator", "validateNoTypeParameterOnParameterizedType", 4, 2, "pholser@alumni.rice.edu").
...
method("NoGenericTypeParametersValidator", "validateNoTypeParameterOnWildcardType", 6, 3, "pholser@alumni.rice.edu").
...
method("SynchronizedRunListener", "testSuiteStarted", 5, 1, "charlie@yandex-team.ru").
calls("SynchronizedRunListener", "testSuiteStarted", "RunListener", "testSuiteStarted").
method("SynchronizedRunListener", "testSuiteFinished", 5, 1, "charlie@yandex-team.ru").
calls("SynchronizedRunListener", "testSuiteFinished", "RunListener", "testSuiteFinished").
method("SynchronizedRunListener", "testStarted", 5, 1, "saff@google.com").
calls("SynchronizedRunListener", "testStarted", "RunListener", "testStarted").
method("SynchronizedRunListener", "testFinished", 5, 1, "saff@google.com").
calls("SynchronizedRunListener", "testFinished", "RunListener", "testFinished").
method("SynchronizedRunListener", "testFailure", 5, 1, "saff@google.com").
calls("SynchronizedRunListener", "testFailure", "RunListener", "testFailure").
method("SynchronizedRunListener", "testAssumptionFailure", 5, 1, "saff@google.com").
calls("SynchronizedRunListener", "testAssumptionFailure", "RunListener", "testAssumptionFailure").
method("SynchronizedRunListener", "testIgnored", 5, 1, "saff@google.com").
calls("SynchronizedRunListener", "testIgnored", "RunListener", "testIgnored").
method("SynchronizedRunListener", "hashCode", 3, 1, "saff@google.com").
...
class("RunListener").
method("RunListener", "testRunStarted", 1, 1, "dsaff").
method("RunListener", "testRunFinished", 1, 1, "dsaff").
method("RunListener", "testSuiteStarted", 1, 1, "charlie@yandex-team.ru").
method("RunListener", "testSuiteFinished", 1, 1, "charlie@yandex-team.ru").
method("RunListener", "testStarted", 1, 1, "dsaff").
method("RunListener", "testFinished", 1, 1, "dsaff").
method("RunListener", "testFailure", 1, 1, "dsaff").
method("RunListener", "testAssumptionFailure", 1, 1, "dsaff").
method("RunListener", "testIgnored", 1, 1, "dsaff").
...
method("RunNotifier", "fireTestAssumptionFailed", 3, 1, "dsaff").
method("RunNotifier", "fireTestIgnored", 3, 1, "dsaff").
...
class("Filter").
method("Filter", "matchMethodDescription", 3, 1, "saff@dhcp-172-31-197-71.cam.corp.google.com").
method("Filter", "shouldRun", 1, 1, "dsaff").
method("Filter", "describe", 1, 1, "dsaff").
method("Filter", "apply", 7, 2, "dsaff").
calls("Filter", "apply", "Filterable", "filter").
method("Filter", "intersect", 7, 2, "david@saff.net").
...
method("TestSetup", "tearDown", 1, 1, "dsaff").
...
method("TestDecorator", "run", 3, 1, "dsaff").
calls("TestDecorator", "run", "TestDecorator", "basicRun").
method("TestDecorator", "toString", 3, 1, "dsaff").
calls("TestDecorator", "toString", "Test", "toString").
method("TestDecorator", "getTest", 3, 1, "dsaff").
...
method("BaseTestRunner", "savePreferences", 7, 1, "dsaff").
...
method("BaseTestRunner", "addFailure", 3, 1, "dsaff").
calls("BaseTestRunner", "addFailure", "BaseTestRunner", "testFailed").
method("BaseTestRunner", "testStarted", 1, 1, "dsaff").
...
method("TestSuite", "runTest", 3, 1, "dsaff").
calls("TestSuite", "runTest", "Test", "run").
method("TestSuite", "setName", 3, 1, "dsaff").
method("TestSuite", "testAt", 3, 1, "dsaff").
calls("TestSuite", "testAt", "Vector", "get").
method("TestSuite", "testCount", 3, 1, "dsaff").
calls("TestSuite", "testCount", "Vector", "size").
method("TestSuite", "tests", 3, 1, "dsaff").
...
method("JUnit4TestAdapter", "removeIgnored", 12, 4, "dsaff").
...
method("JUnit4TestAdapter", "sort", 3, 1, "dsaff").
...
method("TestCase", "run", 3, 1, "dsaff").
calls("TestCase", "run", "TestResult", "run").
method("TestCase", "runBare", 18, 5, "dsaff").
...
method("TestCase", "assertTrue", 3, 1, "awulder@xebia.com").
calls("TestCase", "assertTrue", "Assert", "assertTrue").
method("TestCase", "assertTrue", 3, 1, "awulder@xebia.com").
calls("TestCase", "assertTrue", "Assert", "assertTrue").
method("TestCase", "assertFalse", 3, 1, "awulder@xebia.com").
calls("TestCase", "assertFalse", "Assert", "assertFalse").
method("TestCase", "assertFalse", 3, 1, "awulder@xebia.com").
calls("TestCase", "assertFalse", "Assert", "assertFalse").
method("TestCase", "fail", 3, 1, "awulder@xebia.com").
calls("TestCase", "fail", "Assert", "fail").
method("TestCase", "fail", 3, 1, "awulder@xebia.com").
calls("TestCase", "fail", "Assert", "fail").
method("TestCase", "assertEquals", 3, 1, "awulder@xebia.com").
...
method("TestCase", "assertEquals", 3, 1, "awulder@xebia.com").
calls("TestCase", "assertEquals", "Assert", "assertEquals").
method("TestCase", "assertNotNull", 3, 1, "awulder@xebia.com").
calls("TestCase", "assertNotNull", "Assert", "assertNotNull").
method("TestCase", "assertNotNull", 3, 1, "awulder@xebia.com").
calls("TestCase", "assertNotNull", "Assert", "assertNotNull").
method("TestCase", "assertNull", 3, 1, "awulder@xebia.com").
calls("TestCase", "assertNull", "Assert", "assertNull").
method("TestCase", "assertNull", 3, 1, "awulder@xebia.com").
calls("TestCase", "assertNull", "Assert", "assertNull").
method("TestCase", "assertSame", 3, 1, "awulder@xebia.com").
calls("TestCase", "assertSame", "Assert", "assertSame").
method("TestCase", "assertSame", 3, 1, "awulder@xebia.com").
calls("TestCase", "assertSame", "Assert", "assertSame").
method("TestCase", "assertNotSame", 3, 1, "awulder@xebia.com").
calls("TestCase", "assertNotSame", "Assert", "assertNotSame").
method("TestCase", "assertNotSame", 3, 1, "awulder@xebia.com").
calls("TestCase", "assertNotSame", "Assert", "assertNotSame").
method("TestCase", "failSame", 3, 1, "awulder@xebia.com").
calls("TestCase", "failSame", "Assert", "failSame").
method("TestCase", "failNotSame", 3, 1, "awulder@xebia.com").
calls("TestCase", "failNotSame", "Assert", "failNotSame").
method("TestCase", "failNotEquals", 3, 1, "awulder@xebia.com").
calls("TestCase", "failNotEquals", "Assert", "failNotEquals").
method("TestCase", "format", 3, 1, "awulder@xebia.com").
...
method("TestResult", "runCount", 3, 1, "dsaff").
method("TestResult", "runProtected", 10, 4, "dsaff").
...
method("TestResult", "shouldStop", 3, 1, "dsaff").
method("TestResult", "startTest", 8, 2, "dsaff").
...
method("Assert", "assertNotSame", 3, 1, "dsaff").
calls("Assert", "assertNotSame", "Assert", "assertNotSame").
method("Assert", "failSame", 4, 1, "dsaff").
calls("Assert", "failSame", "Assert", "fail").
...
method("JUnit4TestAdapterCache", "getDefault", 3, 1, "dsaff").
method("JUnit4TestAdapterCache", "asTest", 10, 3, "dsaff").
...
method("JUnit4TestCaseFacade", "run", 3, 1, "dsaff").
method("JUnit4TestCaseFacade", "getDescription", 3, 1, "dsaff").
...
method("ResultPrinter", "printWaitPrompt", 4, 1, "dsaff").
calls("ResultPrinter", "printWaitPrompt", "ResultPrinter", "getWriter").
calls("ResultPrinter", "printWaitPrompt", "ResultPrinter", "getWriter").
method("ResultPrinter", "printHeader", 4, 1, "dsaff").
...
method("ResultPrinter", "printDefectHeader", 3, 1, "dsaff").
calls("ResultPrinter", "printDefectHeader", "ResultPrinter", "getWriter").
method("ResultPrinter", "printDefectTrace", 3, 1, "dsaff").
calls("ResultPrinter", "printDefectTrace", "ResultPrinter", "getWriter").
method("ResultPrinter", "printFooter", 12, 2, "dsaff").
...
calls("ResultPrinter", "printFooter", "ResultPrinter", "getWriter").
calls("ResultPrinter", "printFooter", "ResultPrinter", "getWriter").
method("ResultPrinter", "elapsedTimeAsString", 3, 1, "dsaff").
calls("ResultPrinter", "elapsedTimeAsString", "NumberFormat", "getInstance").
method("ResultPrinter", "getWriter", 3, 1, "dsaff").
method("ResultPrinter", "addError", 3, 1, "dsaff").
calls("ResultPrinter", "addError", "ResultPrinter", "getWriter").
method("ResultPrinter", "addFailure", 3, 1, "dsaff").
calls("ResultPrinter", "addFailure", "ResultPrinter", "getWriter").
method("ResultPrinter", "endTest", 1, 1, "dsaff").
method("ResultPrinter", "startTest", 7, 2, "dsaff").
...
method("TestRunner", "runAndWait", 4, 1, "dsaff").
calls("TestRunner", "runAndWait", "TestRunner", "doRun").
method("TestRunner", "testFailed", 1, 1, "dsaff").
method("TestRunner", "testStarted", 1, 1, "dsaff").
method("TestRunner", "testEnded", 1, 1, "dsaff").
method("TestRunner", "createTestResult", 3, 1, "dsaff").
method("TestRunner", "doRun", 3, 1, "dsaff").
calls("TestRunner", "doRun", "TestRunner", "doRun").
method("TestRunner", "doRun", 11, 1, "dsaff").
